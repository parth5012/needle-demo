...
class Needle3InferenceEngine:
    """
    Needle 3 Local Inference Engine.
    
    Processes unstructured natural language text / audio transcripts into structured
    Artify Bharat Artisan Onboarding models with contextual extraction, entity recognition,
    and field confidence scoring.
    """
    ...
    def extract(self, req: ExtractionRequest) -> ExtractionResponse:
        ...
        # 4. Extract Govt IDs (Pehchan ID, TRIFED ID)
        ...
        # 7. Extract Craft Category & GI Tag
    ...
    def _extract_name(self, text: str) -> Tuple[Optional[str], float, Optional[str]]:
        ...
        # Fallback heuristic: First capitalized 2 words if introduced early
        words = text.split()
